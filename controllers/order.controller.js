...
exports.newPayment = exports.sendStripePublishableKey = exports.getAllOrdersDashBoard = exports.createOrder = void 0;
...
exports.createOrder = (0, catchAsyncErrors_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (payment_info) {
            if ("id" in payment_info) {
                ...
                if (paymentIntent.status !== "succeded") {
                    return next(new ErrorHandler_1.default("Payment not authoriezd!", 400));
                }
            }
        }
        ...
        yield course.save();
        // two questions:
        // 1. createNewOrder receives 2 arguments, how do we pass 3?
        // 2. inside createNewOrder we call await shouldn't we call await before createNewOrder?
        (0, order_service_1.createNewOrder)(data, res, next);
    }
    catch (error) {
        return next(new ErrorHandler_1.default(error.message, 500));
    }
...
exports.getAllOrdersDashBoard = (0, catchAsyncErrors_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        (0, order_service_1.getAllOrdersServiceFunc)(res);
    }
    catch (error) {
        return next(new ErrorHandler_1.default(error.message, 500));
    }
