...
userRouter.get("/get-all-users", auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("admin"), user_controller_1.getAllUsersDashBoard);
...
userRouter.post("/forgot-password", user_controller_1.forgotPasswordStepOne);
userRouter.get("/forgot-password/:forgotPasswordToken", user_controller_1.forgotPasswordStepTwo);
