...
exports.getAllCoursesServiceFunc = exports.createCourse = void 0;
...
// Get all Users
const getAllCoursesServiceFunc = (res) => __awaiter(void 0, void 0, void 0, function* () {
    const courses = yield course_model_1.default.find().sort({ createdAt: -1 });
    res.status(201).json({ success: true, courses });
});
exports.getAllCoursesServiceFunc = getAllCoursesServiceFunc;
