...
exports.updateUserRoleService = exports.getAllUsersServiceFunc = exports.getUserById = void 0;
...
// Get all Users
const getAllUsersServiceFunc = (res) => __awaiter(void 0, void 0, void 0, function* () {
    const users = yield user_model_1.default.find().sort({ createdAt: -1 });
    res.status(201).json({ success: true, users });
});
exports.getAllUsersServiceFunc = getAllUsersServiceFunc;
// Update user role
